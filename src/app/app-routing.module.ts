...
const routes: Routes = [
  ...
  // { path: 'admin/register', loadChildren:()=>import('@modules/users/register/register.module').then(m=>m.RegisterModule), title: 'Register' },
  {
    path: 'admin', canActivate: [AuthGuard], children: [
      { path: '', pathMatch: 'full', loadChildren: () => import('@modules/admin/admin/admin.module').then(m => m.AdminModule), title: 'Administration Panel' },
      { path: 'create', loadChildren: () => import('@modules/admin/painting-new/painting-new.module').then(m => m.PaintingNewModule), title: 'Create New Painting' },
      { path: 'update/:id', loadChildren: () => import('@modules/admin/painting-update/painting-update.module').then(m => m.PaintingUpdateModule), title: 'Update Painting' },
      { path: 'show/users', loadChildren: () => import('@modules/admin/users/users.module').then(m => m.AdminUsersModule), title: 'Registered Users' },
      { path: 'change/portrait/:id', loadChildren: () => import('@modules/admin/portrait/portrait.module').then(m => m.PortraitModule), title: 'Change Portrait' },
      // { path: 'save/token', loadChildren:()=>import('@modules/admin/token-new/token-new.module').then(m=>m.TokenNewModule), title: 'Create New Instagram Token' },
      { path: 'change/token/:id', loadChildren: () => import('@modules/admin/token-update/token-update.module').then(m => m.TokenUpdateModule), title: `Refresh Instagram's Token` }
    ]
  },
